...
import ProductDetailLayout01Tab from "@app/(product)/product-detail-swatch-radio/DescriptionTab";
...
import ProductSwiper from "@app/(product)/product-detail-swatch-radio/ProductSwiper";
import MobileAccordion from "@app/(product)/product-detail-swatch-radio/MobileAccordion";
