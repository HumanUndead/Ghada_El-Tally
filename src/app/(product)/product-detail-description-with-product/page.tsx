...
import ProductSwiper from '@app/(product)/product-detail-description-with-product/ProductSwiper'
import DescriptionTab from '@app/(product)/product-detail-description-with-product/DescriptionTab'
...
import MobileAccordion from '@app/(product)/product-detail-description-with-product/MobileAccordion'
