                            ...
                            <Row className='g-2'>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size1} alt="Size1Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size2} alt="Size2Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size3} alt="Size3Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size4} alt="Size4Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size2} alt="Size2Img" />
                                            </SwiperSlide>
                                    ...
                                    <Row className="g-2">
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card rounded">
                                                <Image src={advanceProduct1} className="img-fluid w-100" style={{ height: "120px" }} alt="AdvanceProduct1Img" />
                                                <p className="text-black text-center my-1">Tank</p>
                                            </div>
                                        </div>
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card advance-card1 rounded">
                                                <Image src={advanceProduct3} className="img-fluid w-100" style={{ height: "120px" }} alt="AdvanceProduct3Img" />
                                                <p className="text-black text-center my-1">Hoodie</p>
                                            </div>
                                        </div>
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card advance-card1 rounded">
                                                <Image src={advanceProduct5} className="img-fluid w-100" style={{ height: "120px" }} alt="AdvanceProduct5Img" />
