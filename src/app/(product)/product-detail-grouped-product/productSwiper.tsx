                    ...
                    <Col md={6} className='mt-5 mt-md-0'>
                        ...
                        <Table className="table table-bordered mx-auto">
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg1} className="img-fluid ms-lg-3" alt="TableImg1Img" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg2} className="img-fluid ms-lg-3" alt="TableImg2Img" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg3} className="img-fluid ms-lg-3" alt="TableImg3Img" />
                                    </th>
                                    <td>
                                        <div className="mt-lg-5 text-center">
                                ...
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg4} className="img-fluid ms-lg-3" alt="TableImg4Img" />
                                    </th>
                                    <td>
                                        <div className="p-lg-3 text-center">
