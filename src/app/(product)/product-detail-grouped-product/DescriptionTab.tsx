        ...
        <React.Fragment>
            <div className="mt-4 mb-5 py-5 d-none d-lg-block main-project-section ">
                <div className="container">
                    <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={activeKey} onSelect={(k: any) => setActiveKey(k)}>
                                ...
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="my-5 g-3">
                                            <Col md={4}>
                                                <Image src={product2} className="img-fluid" alt="Product2Img" />
                                            </Col>
                                            <Col md={4}>
                                                <Image src={product4} className="img-fluid" alt="Product4Img" />
                                            </Col>
                                            <Col md={4} >
                                                <Image src={product1} className="img-fluid" alt="Product1Img" />
                                            </Col>
                                        </Row>
                                        <Row className="align-items-center pt-5">
                                            <Col md={3}>
                                                ...
                                                <div className="text-center text-md-end d-md-flex flex-md-row-reverse align-items-center justify-md-content-end mb-5">
                                                    <div>
                                                        <Image src={uvResistant} className="img-fluid" style={{ width: "44px" }} alt="UvResistantImg" />
                                                    </div>
