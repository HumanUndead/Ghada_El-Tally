...
import ProductDetailLayout01Tab from "@app/(product)/product-detail-swatch-simple-color/ProductDetailsimpleTab";
import ProductSwiper from '@app/(product)/product-detail-swatch-simple-color/ProductSwiper'
...
import MobileAccordion from "@app/(product)/product-detail-swatch-simple-color/MobileAccordion";
