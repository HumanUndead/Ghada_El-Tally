                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product01} className="object-fit-cover" alt="Product01Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="Product02Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product03} className="object-fit-cover" alt="Product03Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product04} className="object-fit-cover" alt="Product04Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="Product02Img" />
                                            </SwiperSlide>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product01} alt="Product01Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product02} alt="Product02Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product03} alt="Product03Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product04} alt="Product04Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product02} alt="Product02Img" />
                                                </SwiperSlide>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={product01} alt="Product01Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
