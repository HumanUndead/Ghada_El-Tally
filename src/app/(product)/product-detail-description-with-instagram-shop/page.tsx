...
import ProductSwiper from '@app/(product)/product-detail-description-with-instagram-shop/ProductSwiper'
import DescriptionTab from '@app/(product)/product-detail-description-with-instagram-shop/DescriptionTab'
import LikeProducts from '@src/commonsections/LikeProducts'
import ViewedProduct from '@src/commonsections/ViewedProducts'
import MobileAccordion from '@app/(product)/product-detail-description-with-instagram-shop/MobileAccordion'
