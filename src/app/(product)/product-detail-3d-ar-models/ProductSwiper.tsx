                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1 bag-swiper">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb01} className="object-fit-cover" alt="Thumb01Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb04} className="object-fit-cover" alt="Thumb04Img" />
                                                <i className="las la-cube"></i>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb03} className="object-fit-cover" alt="Thumb03Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb01} className="object-fit-cover" alt="Thumb01Img" />
                                            </SwiperSlide>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb01} alt="Thumb01Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb04} alt="Thumb04Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb03} alt="Thumb03Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb01} alt="Thumb01Img" />
                                                </SwiperSlide>
