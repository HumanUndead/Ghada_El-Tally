...
import ProductSwiper from "@app/(product)/product-detail-swatch-simple/ProductSwiper";

import des2 from '@assets/images/single-product/des-02.jpg'
import MobileAccordion from "@app/(product)/product-detail-swatch-simple/MobileAccordion";
