                            ...
                            <Row className="g-2">
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb1} className="object-fit-cover" alt="Thumb1Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb2} className="object-fit-cover" alt="Thumb2Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb3} className="object-fit-cover" alt="Thumb3Img" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb1} alt="Thumb1Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb2} alt="Thumb2Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb3} alt="Thumb3Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb2} alt="Thumb2Img" />
                                            </SwiperSlide>
                                ...
                                <div className="row align-items-center mb-5">
                                    <div className="col-xl-6">
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs2} alt="Thumbs2Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs3} alt="Thumbs3Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs4} alt="Thumbs4Img" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                        </ul>
                                    </div>
