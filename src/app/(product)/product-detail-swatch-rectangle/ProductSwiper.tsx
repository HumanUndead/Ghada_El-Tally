                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product4} className="object-fit-cover" alt="Product4Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product5} className="object-fit-cover" alt="Product5Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product31} className="object-fit-cover" alt="Product31Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product42} className="object-fit-cover" alt="Product42Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product43} className="object-fit-cover" alt="Product43Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product32} className="object-fit-cover" alt="Product32Img" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product44} className="object-fit-cover" alt="Product44Img" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product4} alt="Product4Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product5} alt="Product5Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product31} alt="Product31Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product42} alt="Product42Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product43} alt="Product43Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product32} alt="Product32Img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product44} alt="Product44Img" />
                                                </SwiperSlide>
                                            </div>
